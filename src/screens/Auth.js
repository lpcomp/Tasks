        ...
        return(
            <ImageBackground source={backgroundImage} style={styles.background} >
                ...
                <View style={styles.formContainer} >
                    ...
                    {this.state.stageNew &&
                        <AuthInput icon='asterisk' secureTextEntry={true} placeholder="Confirmação de senha" style={styles.input} value={this.state.confirmPassword} onChangeText={confirmPassword => this.setState({confirmPassword}) } /> 
                    }
