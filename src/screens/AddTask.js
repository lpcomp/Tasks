...
import { StyleSheet, Text, View, Modal, TextInput, DatePickerIOS, DatePickerAndroid, Platform, TouchableWithoutFeedback, TouchableOpacity, Alert } from 'react-native'
...
export default class AddTaks extends Component {
    ...
    handleDateAndroidChanged = () => { // se receber o dia de hj, fica tudo bem, se não, tá dando erro?
